    ...
    public static int getNetWorkStart(Context context){
        ...
        if (activeNetworkInfo!=null&&activeNetworkInfo.isConnected()){
            ...
            if (activeNetworkInfo.getType()==(ConnectivityManager.TYPE_WIFI)){
                //返回无线网络
                MyLog.e("Current Network Environment","使用WIFI链接状态中:"+NETWORW_WIFI);
                NowNetWoRW = NETWORW_WIFI;
                return NETWORW_WIFI;
                //判断是否移动网络
            }else if (activeNetworkInfo.getType()==(ConnectivityManager.TYPE_MOBILE)){
                //返回移动网络
                MyLog.e("Current Network Environment","使用移动网络链接:"+NETWORK_MOBILE);
                NowNetWoRW = NETWORK_MOBILE;
                return NETWORK_MOBILE;
            }
        }else {
            //没有网络
            MyLog.e("Current Network Environment","未检测到当前网络状态:"+NETWORK_MOBILE);
            return NETWORK_NONE;
        }
        //默认返回  没有网络
        return NETWORK_NONE;
